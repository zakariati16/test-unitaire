...
public class StringUtils {
    ...
    //isprefix ("banner","ban")=return true
    //isprefix ("banner","bang")=return false
...
//        String building = qui va renverser une chaine de caractere
    ...
    public static String reverseString(String str) {
        String reversed="";
        // apres le test on a rajouter la majuscule
        str = str.toLowerCase();
    ...
    public static boolean isPalindrom(String str) {
        // on a rajouter les majuscules parceque dans le test ne prend pas ca en consideration
        //la ligne 41 du class test est devenue true grace à l'ajout du majuscule dans le code
         str=str.toLowerCase();
         // pour supprimer l'espace dans un string
